            ...
            >
                ...
                <form method="post" encType="multipart/form-data" action="#" ref={ref}>
                    <div className="ticket-section">
                        <div className="form-block">
                            <div className="inputblock mb-3">
                                <label htmlFor="ct3">Add your note</label>
                    ...
                    <div className="ticket-section controls">
                        <button onClick={e=>closeModalCart(true,ref.current.note.value)} type="button" className="cl-btn c-orange">{`${orderState===0?'Checkout':'Update'}`}</button>
                    </div>
                </form>
            </div>
        </div>
